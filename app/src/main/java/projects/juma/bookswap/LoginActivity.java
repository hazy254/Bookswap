...
import projects.juma.bookswap.DBTools;
import projects.juma.bookswap.User;

import projects.juma.bookswap.R;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    @Override
    protected void onNewIntent(Intent myIntent){
        super.onNewIntent(myIntent);
        if(myIntent.getStringExtra("myIntent").equals("myMethod"));
        session.logoutUser();
    }
}
